...
function Main() {
  ...
  console.log(formData.inputFrom);
  return (
    <main className="px-8 md:px-0 grow-1 mt-12 antialiased">
      <div
        id="select-wrapper"
        className="
            flex
      ...
      >
        ...
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-7 w-7 sm:h-8 sm:w-8 text-cyan-500 cursor-pointer"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
      ...
      <div
        className="
            ...
            mt-4
            space-y-3
            md:space-y-0 md:flex md:justify-between md:items-center md:space-x-4
          "
      >
        ...
        <div className="w-full relative">
          ...
          ></textarea>
          <button
            className="focus:outline-none absolute bottom-3 right-12"
            id="copy-btn"
            onClick={async () => {
